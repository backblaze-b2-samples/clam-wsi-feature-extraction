...
from app.runtime import files, health, metrics, ratelimit, slides, upload  # noqa: E402
...
# (B2_REGION ships with a real default, so it has no placeholder.)
...
API_TITLE = "CLAM WSI Feature Extraction API"
API_DESCRIPTION = (
