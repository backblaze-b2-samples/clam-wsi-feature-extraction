...
def _client():
    ...
    # of truth for both the region and the derived endpoint (no hardcoded region).
    return boto3.client(
        "s3",
        ...
        config=Config(signature_version="s3v4", user_agent_extra="b2ai-clam-wsi-feature-extraction"),
    )
