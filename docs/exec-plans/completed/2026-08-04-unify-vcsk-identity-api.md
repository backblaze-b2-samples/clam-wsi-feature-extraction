...
Make CLAM WSI Feature Extraction the canonical identity across the shipped web app,
...
The web app and local API now ship under the CLAM WSI Feature Extraction identity.
